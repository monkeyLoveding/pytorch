...
# Copy unified test requirements into build context (canonical source: repo root test/requirements.txt)
REPO_ROOT="$(cd "${SCRIPT_DIR}/../.." && pwd)"
cp "${REPO_ROOT}/test/requirements.txt" "${SCRIPT_DIR}/requirements-test.txt"
